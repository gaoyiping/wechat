...
function GetChooseGoods(id, name, qian, jifen ,$chushijifen) {
			        ...
			        AddSignRow(id, name, qian, jifen,15511);
...
//添加一个参与人填写行
function AddSignRow(id, name, qian, jifen,yuanshi){ //读取最后一行的行号，存放在txtTRLastIndex文本框中
    ...
    //添加列:价格
     var newJiage=newTR.insertCell(3);
     newJiage.innerHTML = "<input name='jiage" + newTR.rowIndex.toString() + "' id='jiage" + newTR.rowIndex.toString() + "' type='text' onkeyup=\"updateNum1(this,'SignItem" + rowID + "')\"  style='width:50px;' value='"+qian+"' />RMB";
	 newJiage.width=160;
 

     //添加列:数量
     var newNum=newTR.insertCell(4);
     newNum.innerHTML = "<input name='txtNum" + newTR.rowIndex.toString() + "' id='txtNum" + newTR.rowIndex.toString() + "' type='text' onkeyup=\"updateNum(this,'SignItem" + rowID + "')\"  style='width:30px;' value='1' />";
     newNum.width=63;

     
     //添加列:数量
     var newshuliang2=newTR.insertCell(5);
     newshuliang2.innerHTML = "1份";
     newshuliang2.width=63;
...
//更改数量重新绑定统计值
function updateNum(obj,rowid,kucun,zongji,jine,qidingnum,type)
{    
	...
	if(type==1)
	{
     	 ...
     	 if(parseInt(obj.value)%qidingnum!=0)
	 {
	  obj.value="0";
       alert("订购数量必须是装箱数量"+qidingnum+"的倍数！");
	 }
	}
	 

     tongji(zongji,jine,rowid);
}


function tongji(zongji,zongjine,rowid)
{
			  ...
			  var shuliang=0;
                ...
                for(i=1;i<=zongji;i++){
                      ...
                      jine=jine+ (parseInt(document.getElementById("tnum"+i).value)*parseInt(document.getElementById("jiage"+i).value));
				 document.getElementById("xiaoji"+i).value= (parseInt(document.getElementById("tnum"+i).value)*parseInt(document.getElementById("jiage"+i).value));
							...
							document.getElementById("hejimoney").innerHTML=jine+".00";
							document.getElementById("hejimoney1").innerHTML=jine+".00";
