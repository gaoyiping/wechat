...
require_once(dirname(__FILE__).'/webapp/lib/WxPayPubHelper/WxPayPubHelper.php');
	...
	if (!isset($_GET['code']))
	{
		...
		$_SESSION['wxqianbao'] =  $_GET['wxqianbao'];
		//触发微信返回code码
	...
	$wxqianbao = $_SESSION['wxqianbao'];
	$unifiedOrder->setParameter("total_fee",$wxqianbao*100);//总金额
			...
			WeixinJSBridge.invoke(
				...
				function(res){
					...
					if(res.err_msg == "get_brand_wcpay_request:ok" ) {
						alert('支付完成!');location.href='index.php?module=index';
					} 

					if(res.err_msg == "get_brand_wcpay_request:cancel" ) {
						alert('支付取消!');location.href='index.php?module=cart';
					}

					if(res.err_msg == "get_brand_wcpay_request:fail" ) {
						alert('支付失败!');location.href='index.php?module=cart';
					}
				}
			);
		}
