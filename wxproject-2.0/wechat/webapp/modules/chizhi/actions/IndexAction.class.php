	...
	public function execute(){
		...
		if($type=='user'){
			...
			do{
				...
				$sql="insert into ntb_log (userid,money,event,utype) values ('$userid',$nummoney,'会员 $adminid 为 $userid 积分转积分金额:$nummoney',1) ";
				$r= $db -> update($sql);
			...
			if($rollback){
				...
				echo "<script type='text/javascript'>" .
						"alert('转币成功！');" .
						"location.href='index.php?module=chizhi&action=List'; </script>";
			}
			//over	
		}
		return;
