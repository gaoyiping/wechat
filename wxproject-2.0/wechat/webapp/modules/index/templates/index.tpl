...
<div class="total-bar">
<span><b>累计积分：￥{$user->e_money|sprintf}</b></span> <span><b>累计销售：￥{$user->ljxse|sprintf}<b/></span>
</div>
</div>
...
<ul>
	...
	{if $user->uplevel}
	<!-- <div class="padding"><li class="m7"><a href="index.php?module=nochizhi&action=List">积分转购物币</a></li></div> -->
	...
	{/if}
	<!-- <div class="padding"><li class="m3"><a href="index.php?module=cz&action=List">充值积分转购物币<span>余额 ￥{$user->c_money|sprintf}</a></li></div> -->
	<!-- <div class="padding"><li class="m7"><a href="index.php?module=czc&action=List">充值积分转充值积分</a></li></div> -->
	{if $user->uplevel >= 2}
	<div class="padding"><li class="m20"><a href="index.php?module=index&action=Yjkh&pid={$user->user_id}">业绩考核<span></span></a></li></div>
	{/if}
