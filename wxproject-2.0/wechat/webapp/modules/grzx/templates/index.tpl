...
<form method="post" action="" id="form1">
  ...
  <div>
    ...
    <a href="javascript:history.go(-1)" class="return"></a> <span class="linel"></span> <strong>个人中心</strong> </div>
    <div class="content">
      <div class="mem_menu">
        <ul>
          <li><a href="index.php?module=ModifyInfo">资料修改</a></li>
          <li><a href="index.php?module=UpdatePwd">密码修改</a></li>
        </ul>
      </div>
    </div>
  </div>
