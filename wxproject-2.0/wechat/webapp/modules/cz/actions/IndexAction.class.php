	...
	public function execute(){
		...
		if(!$r){
			...
			echo "<script type='text/javascript'>" .
						"alert('用户不存在！');" .
						"location.href='index.php?module=cz'; </script>";
			return ;
		}
		...
		if($type=='user'){
			...
			do{
				...
				$sql="insert into ntb_log (userid,money,event,utype) values ('$userid',$nummoney,'会员 $adminid 为 $userid 充值购物币:$nummoney',1) ";
				$r= $db -> update($sql);
			...
			if($rollback){
				...
				echo "<script type='text/javascript'>" .
						"alert('转币成功！');" .
						"location.href='index.php?module=cz&action=List'; </script>";
			}
			//over	
		}
		return;
