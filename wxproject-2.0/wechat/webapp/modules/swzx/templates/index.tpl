...
<form method="post" action="" id="form1">
  ...
  <div>
    ...
    <a href="javascript:history.go(-1)" class="return"></a> <span class="linel"></span> <strong>商务中心</strong> </div>
    <div class="content">
      <div class="mem_menu">
        <ul>
          <li><a href="index.php?module=showping">注册会员</a></li>
          <li><a href="index.php?module=fxshowping">复消录入</a></li>
          <li><a href="index.php?module=HandleOrder">我的订单</a></li>
        </ul>
      </div>
    </div>
  </div>
