...
class IndexAction extends Action {
	...
	public function getDefaultView() {
		...
		if($pageto == 'all'){
			$sql = "select record.*,t2.card_name as byhname,t2.card_type as byinhang,t2.card_number as byhsNo,t2.tel as btel,t2.provcity as byinhangdiqu " .
				"from ntb_record record ,ntb_user t2 " .
				"where 1 $condition and record.operation = t2.user_id ";
		} else {
			$sql = "select t1.*,t2.card_name as byhname,t2.card_type as byinhang,t2.card_number as byhsNo,t2.tel as btel,t2.provcity as byinhangdiqu  " .
				"from ( " .
