...
<div style="min-height: 446px; width: 100%; height: auto !important; overflow: visible"
    ...
    <form action="index.php?module=addadmin&action=add" method="post" name="form1" onsubmit="return check(this);" enctype="multipart/form-data">
                            ...
                            <td height="56" valign="top">
                                <table align="center" bgcolor="#DDDDDD" width="100%" border="0" cellpadding="5" cellspacing="1" >
                                    ...
                                    <tr class="td4">
                                        ...
                                        <td><input name='admin_id' type="text" style="width:200px;" class="dfinput" >
