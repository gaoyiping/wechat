    ...
    <form name="form1" action="index.php" method="get">
        ...
        <table width=99% border=0 align="center" >
            <tr><td>
                ...
                <select id="Select1" style="height:24px;" name="Select1" onchange="selectCity();">
                    <option value="" selected="true">省/直辖市</option>
                </select>
                <select id="Select2" style="height:24px;" name="Select2" onchange="selectCountry()">
                    <option value="" selected="true">请选择</option>
                </select>
                <select id="Select3" style="height:24px;" name="Select3" >
                    <option value="" selected="true">请选择</option>
                </select>
        ...
        {foreach from=$userlist item=item name=f1}
            <tr bgColor=#FFFFFF>
                ...
                <td align="center">
                    ...
                    {*<font color="#1166FF">{if  $item->level==6} 伙计{/if}</font>*}
