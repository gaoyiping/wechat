                        			...
                        			<form method="post" action="">
                        				<table align="center" width="100%" border="0" cellpadding="0" cellspacing="0" id="table1">
                        					...
                        					<tr><td style="padding-left: 230px; padding-top: 4px;font-weight:bold;">
                        						掌柜总数：{$Total2->count}人。&nbsp;&nbsp;完成考核：<b style="color: #c9302c;">{$Level2->count}</b>人。
                        					</td></tr>
                        					<tr><td style="padding-left: 230px; padding-top: 4px;font-weight:bold;">
                        						东家总数：{$Total3->count}人。&nbsp;&nbsp;完成考核：<b style="color: #c9302c;">{$Level3->count}</b>人。
                        					</td></tr>
                        					<tr><td style="padding-left: 230px; padding-top: 4px;font-weight:bold;">
                        						富豪总数：{$Total4->count}人。&nbsp;&nbsp;完成考核：<b style="color: #c9302c;">{$Level4->count}</b>人。
                        					</td></tr>
                        					<tr><td style="padding-left: 230px; padding-top: 4px;font-weight:bold;">
                        						大富豪总数：{$Total5->count}人。&nbsp;&nbsp;完成考核：<b style="color: #c9302c;">{$Level5->count}</b>人。
                        					</td></tr>
                        					<tr>
                        						<td height="25" style="padding-top: 10px; padding-left: 230px;" >
                        							掌柜：<input type="text" name="Normal2" value="0" /> 元/人<br/>
                        							<b style="color: #c9302c;">完成考核</b>：<input type="text" name="Vip2" value="0" /> 元/人<br/>
                        							<br/>
                        							东家：<input type="text" name="Normal3" value="0" /> 元/人<br/>
                        							<b style="color: #c9302c;">完成考核</b>：<input type="text" name="Vip3" value="0" /> 元/人<br/>
                        							<br/>
                        							富豪：<input type="text" name="Normal4" value="0" /> 元/人<br/>
                        							<b style="color: #c9302c;">完成考核</b>：<input type="text" name="Vip4" value="0" /> 元/人<br/>
                        							<br/>
                        							大富豪：<input type="text" name="Normal5" value="0" /> 元/人<br/>
                        							<b style="color: #c9302c;">完成考核</b>：<input type="text" name="Vip5" value="0" /> 元/人<br/>
                        							<br/>
