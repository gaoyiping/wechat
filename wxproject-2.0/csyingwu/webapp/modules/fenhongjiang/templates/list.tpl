                    ...
                    <td class="line_leftright_borderclor">
                        ...
                        <div style="margin-top: -1px; height: 30px;  overflow: hidden" id="ctl00_Div_right_top"
                            ...
                            <div style="position: relative; line-height: 30px; width: 100%">
                                &nbsp;<span class="Font_red Font_addbold">[会员管理]</span> >> 分红奖工资表
...
<input type="hidden" name="module" value="fenhongjiang" />
...
&nbsp;&nbsp;账号 <input name="user_id" value="{$user_id}" size="8"   class="button1" />
     ...
     <input type="submit" value="查 询" class="b02">  <input type="button" value="导出EXCEL" class="b02" onclick="location.href=location.href+'&pageto=all';"> 
<td align="right"> 本期奖金总计：￥<font color="red">{$zongjin|sprintf}</td>
  </td></tr>
</table>
</form></div><br />
<form name="form2" method="post" action="index.php?module=fenhongjiang&action=okall" >
  {literal}
<script type="text/javascript">
function ccolor(c){
  if(c.checked){
  ...
  <table border="0" cellpadding="1" cellspacing="1" width="100%">
    <tr class="td3"> 
     <td width="3%"><div align="center"><font color="#FFFFFF">选</font></div></td>
	   ...
	   <td width="9%"><div align="center"><font color="#FFFFFF">账号</font></div></td>
	   <td width="9%"><div align="center"><font color="#FFFFFF">姓名</font></div></td>
	   <td width="9%"><div align="center"><font color="#FFFFFF">旅游奖</font></div></td>
	   <td width="9%"><div align="center"><font color="#FFFFFF">车房奖</font></div></td>
	   <td width="9%"><div align="center"><font color="#FFFFFF">领袖奖</font></div></td>
	...
	<td><div align="right">{$item->l_money|sprintf}&nbsp;</div></td>
	<td><div align="right">{$item->c_money|sprintf}</div></td>
	<td><div align="right">{$item->lx_money|sprintf}</div></td>
