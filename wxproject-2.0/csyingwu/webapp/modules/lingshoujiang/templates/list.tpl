                    ...
                    <td class="line_leftright_borderclor">
                        ...
                        <div style="margin-top: -1px; height: 30px;  overflow: hidden" id="ctl00_Div_right_top"
                            ...
                            <div style="position: relative; line-height: 30px; width: 100%">
                                &nbsp;<span class="Font_red Font_addbold">[会员管理]</span> >> 复消奖工资表
...
<input type="hidden" name="module" value="lingshoujiang" />
...
<form name="form2" method="post" action="index.php?module=lingshoujiang&action=okall" >
  {literal}
<script type="text/javascript">
function ccolor(c){
  if(c.checked){
  ...
  <table border="0" cellpadding="1" cellspacing="1" width="100%">
    <tr class="td3"> 
     <td width="3%"><div align="center"><font color="#FFFFFF">选</font></div></td>
	   ...
	   <td width="9%"><div align="center"><font color="#FFFFFF">零售奖</font></div></td>
	...
	<td><div align="right">{$item->f_moeny|sprintf}</div></td>
    <td><div align="right" style='color:#120DD2;'>{$item->f_money|sprintf}&nbsp;</div></td>
	<td><div align="center">
