                    ...
                    <td class="line_leftright_borderclor">
                        ...
                        <div style="margin-top: -1px; height: 30px;  overflow: hidden" id="ctl00_Div_right_top"
                            ...
                            <div style="position: relative; line-height: 30px; width: 100%">
                                &nbsp;<span class="Font_red Font_addbold">[进销存管理]</span> >> 产品出库
                            </div>
                        </div>
...
<input type="hidden" name="module" value="kucun1" />
<table width="95%" border=0 align="center">
  <tr><td>
   <a href="index.php?module=kucun2">库存管理</a> | <a href="index.php?module=xiaoshou" >销售明细</a>  | <a href="index.php?module=kucun" >入库明细</a>  | <a href="index.php?module=kucun1" ><b>出库明细</b></a> | <a href="index.php?module=zengpin" >赠品明细</a>    &nbsp;&nbsp;产品关键字
...
<table align="center" bgcolor="#dedede" border="0" cellpadding="0" cellspacing="0" width="95%"><tr><td>
  <table border="0" cellpadding="5" cellspacing="1" width="100%">
    ...
    <td width="4%"><div align="center"><font color="#FFFFFF">序</font></div></td>
        <td width="20%"><div align="center"><font color="#FFFFFF">商品名称</font></div></td>
      <td width="10%"><div align="center"><font color="#FFFFFF">商品编号</font></div></td>

  
         <td width="7%"><div align="center"><font color="#FFFFFF">单位</font></div></td>
      <td width="8%"><div align="center"><font color="#FFFFFF">数量</font></div></td>
       <td width="8%"><div align="center"><font color="#FFFFFF">出库类型</font></div></td>
         <td width="20%"><div align="center"><font color="#FFFFFF">备注</font></div></td>
        <td width="15%"><div align="center"><font color="#FFFFFF">出库时间</font></div></td>
	...
	<td >
        <div align="center">{if $item->rleixing==1}产品损耗{/if}{if $item->rleixing==2}内部消耗{/if}{if $item->rleixing==3}退换货{/if}</div></td>
	<td >
        <div align="center">{$item->rbeizhu}</div></td>
	<td >
