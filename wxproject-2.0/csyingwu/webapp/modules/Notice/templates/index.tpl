                ...
                <table cellspacing="1" cellpadding="1" width="100%">
                    <tr class="tdTitle" >
                        <td height="25" align="center" colspan=2>
                            <font color="#141414" > 发布公告 </font></td>
                    </tr>
                    <tr bgcolor="#FFFFFF">
                        <td  class="table_body">标 题：</td> <td class="table_none"> <input name="title"  class="button1"  type="text" id="title" style="width:260px; height:24px;" /></td>
                    </tr>
                    <tr bgcolor="#FFFFFF">
