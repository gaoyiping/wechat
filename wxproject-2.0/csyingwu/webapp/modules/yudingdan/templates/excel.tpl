...
<table border="1px">
    ...
    <td width="70px" align="center">电话</td>
    <td align="center">订单详情(序号、商品名、数量、提供资料)</td>
    ...
    <td align="center" style="padding: 0;">
      ...
      {foreach from=$item1->details item=item2 name=f2}
        <tr>
          ...
          <td align="left" style="border:1px solid black;">{$item2.pname}</td>
          <td align="center" style="border:1px solid black;" width="15px">{$item2.count}</td>
          <td align="center" style="border:1px solid black;" width="20px">{if $item2.withinfo=='1'}是{else}否{/if}</td>
        </tr>
      {/foreach}
      </table>
    </td>
