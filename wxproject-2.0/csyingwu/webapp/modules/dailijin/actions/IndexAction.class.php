...
class IndexAction extends Action {
	...
	public function getDefaultView() {
       ...
       $condition = '';
		...
		$sql = "select count(a.id) c,sum(y_money) as zongjin  from ntb_money a left join ntb_user b on a.userid=b.user_id where 1=1  $condition";
		...
		{  
			...
			$offset = $pager->offset;
				$url = "module=dailijin&sqishu=$sqishu&user_id=$user_id";
