                    ...
                    <td class="line_leftright_borderclor">
                        ...
                        <div style="margin-top: -1px; height: 30px;  overflow: hidden" id="ctl00_Div_right_top"
                            ...
                            <div style="position: relative; line-height: 30px; width: 100%">
                                &nbsp;<span class="Font_red Font_addbold">[进销存管理]</span> >> 产品入库
                            </div>
                        </div>
...
<input type="hidden" name="module" value="kucun" />
<table width="95%" border=0 align="center">
  <tr><td>
   <a href="index.php?module=kucun2">库存管理</a> | <a href="index.php?module=xiaoshou" >销售明细</a> | <a href="index.php?module=kucun" ><b>入库明细</b></a> | <a href="index.php?module=kucun1" >出库明细</a> | <a href="index.php?module=zengpin" >赠品明细</a>     &nbsp;&nbsp;产品关键字
  ...
  <table border="0" cellpadding="5" cellspacing="1" width="100%">
    <tr class="td3"> 
     <td width="3%"  align="center">序</td>
          <td width="25%"><div align="center"><font color="#FFFFFF">产品名称</font></div></td>
      <td width="15%"><div align="center"><font color="#FFFFFF">产品编号</font></div></td>


         <td width="7%"><div align="center"><font color="#FFFFFF">单位</font></div></td>
      <td width="8%"><div align="center"><font color="#FFFFFF">数量</font></div></td>
        <td width="20%"><div align="center"><font color="#FFFFFF">入库日期</font></div></td>
