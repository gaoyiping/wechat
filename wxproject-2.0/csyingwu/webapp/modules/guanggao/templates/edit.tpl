...
<div style="min-height: 446px; width: 100%; height: auto !important; overflow: visible"
    ...
    <form name="form1" action="index.php?module=guanggao&action=edit"  method="post" onsubmit="return check(this);"  enctype="multipart/form-data" >
                            ...
                            <td height="56" valign="top">
                                <table align="center" bgcolor="#DDDDDD" width="100%" border="0" cellpadding="5" cellspacing="1" >
                                    ...
                                    <tr bgcolor="#FFFFFF">
                                        ...
                                        <td>
                                            <input name="tag_name" value="{$tag_name}" type="text" readonly="readonly" style='width:360px; height:26px;' />
                                        </td>
                                    </tr>
                                    ...
                                    <tr bgcolor="#FFFFFF">
                                        ...
                                        <td>
                                            <input name="tagURL" value="{$tagURL}" type="text" style='width:360px; height:26px;' />
                                        </td>
                                    </tr>
