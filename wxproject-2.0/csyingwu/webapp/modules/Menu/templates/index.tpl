...
<body style="background:#f0f9fd;">
    ...
    <dd>
        ...
        <ul class="menuson" style="display:block">
            ...
            <li><cite></cite><a href="index.php?module=nochizhi&type=user" target="rightFrame">购物币充值</a><i></i></li>
            <li><cite></cite><a href="index.php?module=chizhi&type=user" target="rightFrame">充值币充值</a><i></i></li>
            <li><cite></cite><a href="index.php?module=Recharge&type=user" target="rightFrame">积分充值</a><i></i></li>
            <li><cite></cite><a href="index.php?module=Weektask&type=user" target="rightFrame">周考核</a><i></i></li>
