                    ...
                    <td class="line_leftright_borderclor">
                        ...
                        <div style="margin-top: -1px; height: 30px;  overflow: hidden" id="ctl00_Div_right_top"
                            ...
                            <div style="position: relative; line-height: 30px; width: 100%">
                                &nbsp;<span class="Font_red Font_addbold">[会员管理]</span> >> 见点奖
...
<input type="hidden" name="action" value="jdlist" />
...
<form name="form2" method="post" action="index.php?module=jiang&action=jdokall" >
  {literal}
<script type="text/javascript">
function ccolor(c){
  if(c.checked){
  ...
  <table border="0" cellpadding="1" cellspacing="1" width="100%">
    <tr class="td3"> 
     <td width="3%"><div align="center"><font color="#FFFFFF">选</font></div></td>
	   ...
	   <td width="9%"><div align="center"><font color="#FFFFFF">店铺编号</font></div></td>
	   <td width="9%"><div align="center"><font color="#FFFFFF">店铺名称</font></div></td>
	   <td width="9%"><div align="center"><font color="#FFFFFF">联系人</font></div></td>
	   <td width="9%"><div align="center"><font color="#FFFFFF">见点奖</font></div></td>
	...
	<td><div align="right">{$item->jd_money|sprintf}</div></td>
	<td><div align="center">{$item->add_date|date_format:'%Y-%m-%d'}</div></td>
      <td>
        <div align="center">
