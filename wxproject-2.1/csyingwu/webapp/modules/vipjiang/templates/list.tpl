                    ...
                    <td class="line_leftright_borderclor">
                        ...
                        <div style="margin-top: -1px; height: 30px;  overflow: hidden" id="ctl00_Div_right_top"
                            ...
                            <div style="position: relative; line-height: 30px; width: 100%">
                                &nbsp;<span class="Font_red Font_addbold">[奖金管理]</span> >> VIP工资表
                            </div>
                        </div>
...
<input type="hidden" name="module" value="vipjiang" />
...
<form name="form2" method="post" action="index.php?module=vipjiang&action=okall" >
  {literal}
<script type="text/javascript">
function ccolor(c){
  if(c.checked){
     ...
     <td width="3%"><div align="center"><font color="#FFFFFF">选</font></div></td>
	   ...
	   <td width="9%"><div align="center"><font color="#FFFFFF">账号</font></div></td>
	    <td width="9%"><div align="center"><font color="#FFFFFF">姓名</font></div></td>
	     <td width="9%"><div align="center"><font color="#FFFFFF">直推奖</font></div></td>
	      <td width="9%"><div align="center"><font color="#FFFFFF">点点奖</font></div></td>
