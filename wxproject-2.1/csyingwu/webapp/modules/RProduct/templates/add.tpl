    ...
    <table width="80%" border='0' cellpadding=4 cellspacing=1 align="center">
        ...
        <tr class="tdTitle"  >
            <td height="25" align="center" colspan=2>
                <font color="#141414" > 添加产品信息 </font></td>
        </tr>
        <tr>
        ...
        <tr><td class="table_body">PV：</td> <td  class="table_none">
                ...
                <input name="jifen" type="text" class="button1" style="width:100px;ime-mode:disabled" value="0"/></td>
        </tr>

        <tr><td class="table_body">产品折扣：</td> <td  class="table_none">

                <input name="zhekou" type="text" class="button1"  style="width:100px;ime-mode:disabled" value="100"/> % 代理折扣 默认为100%</td>

        </tr>

        <tr ><td class="table_body">产品利润：</td> <td  class="table_none">

                <input name="lirun" class="button1"  type="text" style="width:100px;ime-mode:disabled" value="0"/> ￥</td>
        </tr>

        <tr><td class="table_body">排序号：</td> <td  class="table_none">

                <input name="sorder" type="text" class="button1"  style="width:100px;ime-mode:disabled" value="100"/></td>
        </tr>
        <tr><td class="table_body">剩余数量提醒：</td> <td  class="table_none">

                <input name="tixingshu" type="text" class="button1"  style="width:100px;ime-mode:disabled" value="50"/> 产品少于某个数字时 显示红色</td>
        </tr>
        <tr><td class="table_body">库存：</td> <td  class="table_none">
                <input name="good_number" type="text" class="button1"  style="width:100px;ime-mode:disabled" value="999"/></td>
        </tr>
        <tr><td class="table_body">新品推荐：</td> <td  class="table_none">
		<label><input type="radio"  name="recommend" value='0' checked>否</label>
		<label><input type="radio"  name="recommend" value='1'>是</label>
          </td>
        </tr>
        <tr><td class="table_body">发现喜欢：</td> <td  class="table_none">
		<label><input type="radio"  name="like" value='0' checked>否</label>
		<label><input type="radio"  name="like" value='1'>是</label></td>
        </tr>
        <tr><td class="table_body">启用状态：</td> <td  class="table_none">

                <select name="isdelete" class="button1" >
        ...
        <tr><td class="table_body">产品图片：</td> <td  class="table_none">
                <input type="file" name="photo_dir" class="button1"  size="15" accept="upload_image/x-png,image/gif,image/jpeg">  注意图片名称请不要带中文。
