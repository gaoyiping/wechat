                ...
                <div style="min-height: 446px; width: 100%; height: auto !important; overflow: visible"
                    ...
                    <div id="ctl00_ContentPlaceHolder1_UpdatePanel1" style="width:100%;text-align:center;">
                        ...
                        <div  class="YFT_huobichongzhi_bg" style="padding-top:110px;padding-left:120px;">
                            ...
                            <form name="form1" action="index.php?module=Recharge"
                                ...
                                <table width="90%" align="center"  border="0" cellpadding="0" cellspacing="0" >
                                    <tr><td>
                                            <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
                                                ...
                                                <tr bgcolor="">
                                                    <td width="30%" height="30" bgcolor="" align="right">充值账号：</td>
                                                    <td width="70%" bgcolor="">
                                                        <input name="userid" class="button1" value="wrj"></td></tr>
                                                <tr bgcolor="">
                                                    <td height="30" bgcolor="" align="right">充值金额：</td>
                                                    <td bgcolor="">
                                                        <input name="amount" class="button1" value="0"></td></tr>
                                                <tr bgcolor="">
