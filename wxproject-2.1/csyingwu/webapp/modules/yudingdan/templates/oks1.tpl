...
<script type="text/javascript">
    function AlertMessageBox()
    {
        ...
        function Showopen(sNo)
        {
            ...
            showPopWin('查看订单详细信息',"index.php?module=yudingdan&action=view&sNo="+sNo, 640, 480, AlertMessageBox,true,true)
        }
</script>
{/literal}
</head>
                    ...
                    <td class="line_leftright_borderclor">
                        ...
                        <div style="margin-top: -1px; height: 30px;  overflow: hidden" id="ctl00_Div_right_top"
                            ...
                            <div style="position: relative; line-height: 30px; width: 100%">
                                &nbsp;<span class="Font_red Font_addbold">[进销存管理]</span> >> 已审核预订单
                            </div>
                        </div>
...
<table width="98%" border=0 align="center"> 
  <tr><td>
     <a href="index.php?module=yudingdan&ok=3">未审核预订单</a> 
      | <a href="index.php?module=weitongguo" >未通过预订单</a> 
      | <a href="index.php?module=yudingdan" ><b>已审核预订单</b></a> &nbsp;&nbsp;订货日期
...
<table align="center"  border="0" cellpadding="0" cellspacing="0" width="98%" bgcolor="#dedede" >
	...
	<td align="center">￥{$item1->moneys}</td>
				...
				<td align="center">{if $item1->status==0}未发货{/if}{if $item1->status==1}未签收{/if}{if $item1->status==2}已完成{/if}</td>
