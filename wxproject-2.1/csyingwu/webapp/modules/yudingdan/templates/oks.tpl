...
{literal}
    function AlertMessageBox()
    {
        ...
        function Showopen(sNo)
        {
            ...
            showPopWin('查看订单详细信息',"index.php?module=HandleOrder&action=view&sNo="+sNo, 640, 480, AlertMessageBox,true,true)
        }
</script>
{/literal}
</head>
...
<table width="98%" border=0 align="center"> 
  <tr><td>
   <a href="index.php?module=yudingdan&ok=3">未审核预订单</a> 
      | <a href="index.php?module=yudingdan&ok=4" ><b>未通过预订单</b></a> 
      | <a href="index.php?module=yudingdan" >已审核预订单</a> &nbsp;&nbsp;订货日期
...
<table align="center"  border="0" cellpadding="0" cellspacing="0" width="98%" bgcolor="#dedede" >
	...
	<td align="center">￥{$item1->moneys}</td>
			      ...
			      <td align="center">{$item1->replay_date|date_format:'%Y-%m-%d'}</td>
