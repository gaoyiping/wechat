...
<form name="form1" method="post">
    <table width="96%" align="center"  border="0" cellpadding="1" cellspacing="1" >
        <tr>
            ...
            <td class="table_none table_none_NoWidth">{$userinfo->user_id}</td>
            <td class="table_body table_body_NoWidth">推荐编号：</td>
            <td class="table_none table_none_NoWidth">{$userinfo->pid}</td>
        </tr>
        ...
        <tr>
            ...
            <td class="table_none table_none_NoWidth">
                ...
                <font color="#1166FF">{if $userinfo->uplevel==7} 董事{/if}</font>
            </td>
        </tr>
        <tr>
            <td class="table_body table_body_NoWidth">银行开户名：</td>
            <td class="table_none table_none_NoWidth">{$userinfo->card_name}</td>
            <td class="table_body table_body_NoWidth">开户银行：</td>
            <td class="table_none table_none_NoWidth">{$userinfo->card_type}</td>
        </tr>
        <tr>
            <td class="table_body table_body_NoWidth">银行开户账号：</td>
            <td class="table_none table_none_NoWidth" colspan=3>{$userinfo->card_number} </td>
        </tr>
        <tr>
            <td class="table_body table_body_NoWidth">银行开户地址：</td>
            <td class="table_none table_none_NoWidth" colspan=3>{$userinfo->provcity} </td>
        </tr>
        <tr>
            <td class="table_body table_body_NoWidth">物流送货地址：</td>
            <td class="table_none table_none_NoWidth" colspan=3>{$userinfo->address}</td>
        </tr>
    </table>
    <br/>
</form>
