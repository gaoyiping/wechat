...
<input type="hidden" name="module" value="fuxiaojiang" />
...
<form name="form2" method="post" action="index.php?module=fuxiaojiang&action=okall" >
  {literal}
<script type="text/javascript">
function ccolor(c){
  if(c.checked){
  ...
  <table border="0" cellpadding="1" cellspacing="1" width="100%">
    <tr class="td3"> 
     <td width="3%"><div align="center"><font color="#FFFFFF">选</font></div></td>
	   ...
	   <td width="9%"><div align="center"><font color="#FFFFFF">复消奖</font></div></td>
