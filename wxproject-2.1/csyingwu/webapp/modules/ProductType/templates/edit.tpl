    ...
    <table width="80%" border='0' cellpadding=4 cellspacing=1 align="center">
        ...
        <tr class="tdTitle"  >
            <td height="25" align="center" colspan=2>
                <font color="#141414" > 修改产品分类 </font></td>
        </tr>
        ...
        <td class="table_body" style="24px;">
            ...
            <select name="ttype">
                ...
                <option {if $ttype==2}selected{/if} value="2">
                    VIP升级
                </option>
                <option  {if $ttype==3}selected{/if} value="3">
                    重复消费
                </option>
            </select></td> </tr>
        <td class="table_body">排序号：</td>   <td  class="table_none">
            <input name="cost" type="text" style="width:200px; height:24px; ime-mode:disabled" class="button1" value="{$cost}"/></td> </tr>
        <tr>
            <td class="table_body">背景色：</td>   <td  class="table_none">
                <input name="bgcolor" type="text" style="width:200px; height:24px; ime-mode:disabled" class="button1" value="{$bgcolor}"/> 建议色值 1: EBF5FD  2: E4E9FF 3: D0F1FE 4: E2FEFA</td> </tr>
