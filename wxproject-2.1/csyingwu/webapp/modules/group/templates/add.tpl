...
{/literal}
<body scroll="no">
<form action="index.php?module=group&action=add" method="post" onsubmit="return check(this);" enctype="multipart/form-data">
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="3" align="center">
                      ...
                      <tr>
                          <td class="table_body">
                              地区</td>
                          <td class="table_none">
								<span id="ctl00_PageBody_CatCountTxt"> <input name="G_CName" type="text" style="width:140px;" /></span></td>
                      </tr>
