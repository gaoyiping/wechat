                    ...
                    <td class="line_leftright_borderclor">
                        ...
                        <div style="margin-top: -1px; height: 30px;  overflow: hidden" id="ctl00_Div_right_top"
                            ...
                            <div style="position: relative; line-height: 30px; width: 100%">
                                &nbsp;<span class="Font_red Font_addbold">[进销存管理]</span> >> 赠品明细
                            </div>
                        </div>
...
<input type="hidden" name="module" value="zengpin" />
<table width="95%" border=0 align="center">
  <tr><td>
   <a href="index.php?module=kucun2">库存管理</a> | <a href="index.php?module=xiaoshou" >销售明细</a> | <a href="index.php?module=kucun" >入库明细</a>  | <a href="index.php?module=kucun1" >出库明细</a> | <a href="index.php?module=zengpin" ><b>赠品明细</b></a>   &nbsp;&nbsp;产品关键字
  ...
  <table border="0" cellpadding="5" cellspacing="1" width="100%">
    ...
    <td width="3%"><div align="center"><font color="#FFFFFF">序</font></div></td>
      ...
      <td width="12%"><div align="center"><font color="#FFFFFF">商品编号</font></div></td>
        <td width="9%"><div align="center"><font color="#FFFFFF">赠送帐号</font></div></td>
      ...
      <td width="6%"><div align="center"><font color="#FFFFFF">数量</font></div></td>
        ...
        <td width="15%"><div align="center"><font color="#FFFFFF">赠送日期</font></div></td>
