...
<form name="f" action="index.php?module=bd" method='post' onsubmit="return SaveVal(this);">
<input type="hidden" name="type" value="user">
<input name="z_money" type="hidden"  value="{$user->j_money}" >
<br/>
<h3>可转金额：</h3>
<p><strong class="red">￥{$user->z_money|sprintf}</strong></p>
<p>转让说明：是将购物币转让给对方的购物币，转让金额50元以上。（购物币无法提现，只能用于购物）</p>

<h3>受让人编号：</h3>

<p class="money"><span class="span2">wrj</span><input style="margin-left:100px" name="userid" type="text"  id="TxtNumb" onblur="checkpid(this.value);" class="how" placeholder="必填项"></p>
